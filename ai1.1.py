	...
	def definebest(self):
		...
		for i in self.populacao:
			...
			if dist<bestdis:
				bestai=i
				bestdis=dist
		print("geracao {} :{}-com {} passos:{}".format(gera,bestai,len(bestai.caminho),bestdis))    #relatorio da situacao
		#print(" 7:{:3d}  -  8:{:3d}  -  9:{:3d}\n 4:{:3d}  -  5:{:3d}  -  6:{:3d}\n 1:{:3d}  -  2:{:3d}  -  3:{:3d}".format(bestai.caminho.count(7),bestai.caminho.count(8),bestai.caminho.count(9),bestai.caminho.count(4),bestai.caminho.count(5),bestai.caminho.count(6),bestai.caminho.count(1),bestai.caminho.count(2),bestai.caminho.count(3)))
		print(" 7:{:3d}  -  8:{:3d}  -  9:{:3d}\n 4:{:3d}  -  5:{:3d}  -  6:{:3d}\n 1:{:3d}  -  2:{:3d}  -  3:{:3d}".format(
            bestai.caminho.count(7),bestai.caminho.count(8),bestai.caminho.count(9),bestai.caminho.count(4),bestai.caminho.count(5),bestai.caminho.count(6),bestai.caminho.count(1),bestai.caminho.count(2),bestai.caminho.count(3)))
		#print(" 7:{:5.2f}  -  8:{:3d}  -  9:{:3d}\n 4:{:3d}  -  5:{:3d}  -  6:{:3d}\n 1:{:3d}  -  2:{:3d}  -  3:{:3d}".format(len(bestai.caminho) // (bestai.caminho.count(7)*100),bestai.caminho.count(8),bestai.caminho.count(9),bestai.caminho.count(4),bestai.caminho.count(5),bestai.caminho.count(6),bestai.caminho.count(1),bestai.caminho.count(2),bestai.caminho.count(3)))
		if bestdis <= goaldist :   
			bestai.caminho.pop()
			global ppg
			ppg=ppg-1
